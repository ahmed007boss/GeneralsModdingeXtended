...
- 16/12/2025 — AI — Initial document created and fully reconstructed per instruction guide (version flags, ActiveBody property inclusion, BodyDamageType completeness, structure).
