...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
class RemoveUpgradeOnUpgradeModuleData : public UpgradeModuleData
{
public:
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
class RemoveUpgradeOnUpgrade : public UpgradeModule
{

	MEMORY_POOL_GLUE_WITH_USERLOOKUP_CREATE( RemoveUpgradeOnUpgrade, "RemoveUpgradeOnUpgrade" )
	MAKE_STANDARD_MODULE_MACRO_WITH_MODULE_DATA( RemoveUpgradeOnUpgrade, RemoveUpgradeOnUpgradeModuleData );

public:

	RemoveUpgradeOnUpgrade( Thing *thing, const ModuleData* moduleData );
