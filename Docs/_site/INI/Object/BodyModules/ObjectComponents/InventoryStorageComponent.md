# <span style="color:#5bbcff; font-weight:bold;">InventoryStorageComponent</span> *(GMX)*
...
- GMX Zero Hour — Adds InventoryStorageComponent (new GMX-only component type for inventory storage effects).

## Document Log

- 16/12/2025 — AI — Initial document created and fully reconstructed per instruction guide (inherited properties, version flags, enum completeness, storage properties, placement, links).
