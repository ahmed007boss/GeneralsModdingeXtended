...
void Drawable::reactToBodyDamageStateChange(BodyDamageType newState)
{
	static const ModelConditionFlagType TheDamageMap[BODYDAMAGETYPE_COUNT] =
	{
		...
		MODELCONDITION_COMPONENT_A_DESTROYED,
		MODELCONDITION_COMPONENT_B_DESTROYED,
		MODELCONDITION_COMPONENT_C_DESTROYED,
		MODELCONDITION_COMPONENT_D_DESTROYED,
		MODELCONDITION_COMPONENT_E_DESTROYED,
		MODELCONDITION_COMPONENT_F_DESTROYED,
		MODELCONDITION_COMPONENT_G_DESTROYED,
		MODELCONDITION_COMPONENT_H_DESTROYED,
		
		MODELCONDITION_COMPONENT_A_DAMAGED,
		MODELCONDITION_COMPONENT_B_DAMAGED,
		MODELCONDITION_COMPONENT_C_DAMAGED,
		MODELCONDITION_COMPONENT_D_DAMAGED,
		MODELCONDITION_COMPONENT_E_DAMAGED,
		MODELCONDITION_COMPONENT_F_DAMAGED,
		MODELCONDITION_COMPONENT_G_DAMAGED,
		MODELCONDITION_COMPONENT_H_DAMAGED,
	...
	clearFlags.set(MODELCONDITION_COMPONENT_ENGINE_DAMAGED);
	clearFlags.set(MODELCONDITION_COMPONENT_TURRET_DESTROYED);
	clearFlags.set(MODELCONDITION_COMPONENT_TURRET_DAMAGED);
	...
	clearFlags.set(MODELCONDITION_COMPONENT_WEAPON_A_DAMAGED);
	clearFlags.set(MODELCONDITION_COMPONENT_WEAPON_B_DAMAGED);
	clearFlags.set(MODELCONDITION_COMPONENT_WEAPON_C_DAMAGED);
	clearFlags.set(MODELCONDITION_COMPONENT_WEAPON_D_DAMAGED);
	clearFlags.set(MODELCONDITION_COMPONENT_WEAPON_E_DAMAGED);
	clearFlags.set(MODELCONDITION_COMPONENT_WEAPON_F_DAMAGED);
	clearFlags.set(MODELCONDITION_COMPONENT_WEAPON_G_DAMAGED);
	clearFlags.set(MODELCONDITION_COMPONENT_WEAPON_H_DAMAGED);

	// Clear all component model conditions
	clearFlags.set(MODELCONDITION_COMPONENT_A_DESTROYED);
	clearFlags.set(MODELCONDITION_COMPONENT_B_DESTROYED);
	clearFlags.set(MODELCONDITION_COMPONENT_C_DESTROYED);
	clearFlags.set(MODELCONDITION_COMPONENT_D_DESTROYED);
	clearFlags.set(MODELCONDITION_COMPONENT_E_DESTROYED);
	clearFlags.set(MODELCONDITION_COMPONENT_F_DESTROYED);
	clearFlags.set(MODELCONDITION_COMPONENT_G_DESTROYED);
	clearFlags.set(MODELCONDITION_COMPONENT_H_DESTROYED);
	// Clear all component damage model conditions
	clearFlags.set(MODELCONDITION_COMPONENT_A_DAMAGED);
	clearFlags.set(MODELCONDITION_COMPONENT_B_DAMAGED);
	clearFlags.set(MODELCONDITION_COMPONENT_C_DAMAGED);
	clearFlags.set(MODELCONDITION_COMPONENT_D_DAMAGED);
	clearFlags.set(MODELCONDITION_COMPONENT_E_DAMAGED);
	clearFlags.set(MODELCONDITION_COMPONENT_F_DAMAGED);
	clearFlags.set(MODELCONDITION_COMPONENT_G_DAMAGED);
	clearFlags.set(MODELCONDITION_COMPONENT_H_DAMAGED);
