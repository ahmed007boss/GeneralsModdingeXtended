# <span style="color:#5bbcff; font-weight:bold;">SensorComponent</span> *(GMX)*
...
- GMX Zero Hour — Adds SensorComponent (new GMX-only component type combining vision and jamming capabilities).

## Document Log

- 16/12/2025 — AI — Initial document created and fully reconstructed per instruction guide (inherited properties, enums, vision/jamming properties, placement, links, defaults).
