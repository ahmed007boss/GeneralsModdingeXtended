...
public:
	...
	*/
	...
	void setSpeedLimit(Real limit) { m_speedLimit = limit; }
	Real getSpeedLimit() const { return m_speedLimit; }
	void clearSpeedLimit() { m_speedLimit = 0.0f; }
	...
	const AsciiString& getConsumeItem() const { return m_consumeItem; }
	Real getConsumeRate() const { return m_consumeRate; }
	...
	*/
	void setAltitudeChangeThresholdForCircling(Real a) { m_circleThresh = a; }
#endif
