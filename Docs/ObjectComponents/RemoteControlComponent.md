...
- 16/12/2025 — AI — Complete reconstruction based on updated instruction file with all inherited Component, ElectronicsComponent, and CommunicationComponent properties, proper version flags, complete enum lists (48 BodyDamageType values), jamming properties documentation, module placement rules, correct linking, and default name handling.
